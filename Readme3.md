...
APPROACH
Class named Student will be created which will conatin void input and int totalcalculate(), where void input() which take the inputs from the user and int totalcalculate() will calcute the total marks obtained by the students and int the main function the highest value calculated by the int calculate() function will be returned.
